...
module.exports = function (sequelize, DataTypes) {
  ...
  TaskStatuses.values = [
    ...
    {id: 3, name: 'Develop stop', createDraftByChangesTaskStatus: false, createDraftByCron: true},
    {id: 4, name: 'Code Review play', createDraftByChangesTaskStatus: true, createDraftByCron: true},
    {id: 5, name: 'Code Review stop', createDraftByChangesTaskStatus: false, createDraftByCron: true},
    {id: 6, name: 'QA play', createDraftByChangesTaskStatus: true, createDraftByCron: true},
    {id: 7, name: 'QA stop', createDraftByChangesTaskStatus: false, createDraftByCron: true},
