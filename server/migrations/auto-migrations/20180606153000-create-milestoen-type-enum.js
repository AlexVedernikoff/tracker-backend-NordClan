...
module.exports = {
    up: function (queryInterface, Sequelize) {
        ...
        .then(()=> queryInterface.createTable('MilestoneTypesDictionary', {
            id: {
              allowNull: false,
              autoIncrement: true,
              primaryKey: true,
        ...
        .then(() => Promise.all(EnumTypes.map((type) => queryInterface.sequelize.query(`
          INSERT INTO MilestoneTypesDictionary (name, code_name)
    ...
    down: function (queryInterface) {
        ...
        .then(() => Promise.all([
            ...
            queryInterface.dropTable('MilestoneTypesDictionary')
        ]));
    }
  };