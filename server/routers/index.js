...
router.put(
  '/user',
  GlobalAccess.can('user', 'updateRole'),
  UserController.updateUserRole
);
router.get(
  '/user/autocompleter',
  GlobalAccess.can('user', 'autocomplete'),
...
router.post(
  '/user/external',
  GlobalAccess.can('user', 'createExternal'),
  UserController.createExternal
);
router.get(
  '/user/external',
  GlobalAccess.can('user', 'getExternalUsers'),
  UserController.getExternalUsers
);
router.put(
  '/user/external/:id',
  GlobalAccess.can('user', 'updateExternal'),
  UserController.updateExternal
);
...
router.get(
  ...
  TagController.autocompliter
);
router.post(
  '/:taggable(project|task)/:taggableId/tag',
  GlobalAccess.can('tag', 'create'),
  TagController.create
);
router.get(
  '/:taggable(project|task)/:taggableId/tag',
  GlobalAccess.can('tag', 'list'),
  TagController.list
);
router.delete(
  '/:taggable(project|task)/:taggableId/tag/:tag',
  GlobalAccess.can('tag', 'delete'),
...
router.post(
  '/project',
  GlobalAccess.can('project', 'create'),
...
router.put(
  '/project/:id',
  GlobalAccess.can('project', 'update'),
  ProjectController.update
);
router.delete(
  '/project/:id',
  GlobalAccess.can('project', 'delete'),
...
router.post(
  ...
  GlobalAccess.can('projectUsers', 'create'),
  ProjectUsersController.create
);
router.get(
  '/project/:projectId/users',
  GlobalAccess.can('projectUsers', 'list'),
  ProjectUsersController.list
);
router.delete(
...
router.get(
  '/portfolio',
  GlobalAccess.can('portfolio', 'list'),
  PortfolioController.list
);
router.put(
  '/portfolio/:id',
  GlobalAccess.can('portfolio', 'update'),
  PortfolioController.update
);
router.get(
  '/portfolio/:id',
  GlobalAccess.can('portfolio', 'read'),
  PortfolioController.read
);
...
router.post(
  '/sprint',
  GlobalAccess.can('sprint', 'create'),
  SprintController.create
);
router.get(
  '/sprint/:id',
  GlobalAccess.can('sprint', 'read'),
  SprintController.read
);
router.put(
  '/sprint/:id',
  GlobalAccess.can('sprint', 'update'),
  SprintController.update
);
router.delete(
  '/sprint/:id',
  GlobalAccess.can('sprint', 'delete'),
  SprintController.delete
);
router.get(
  '/sprint',
  GlobalAccess.can('sprint', 'list'),
...
router.post(
  '/task/:taskId/links/',
  GlobalAccess.can('taskLinks', 'create'),
  TaskTasksController.create
);
router.delete(
  '/task/:taskId/links/:linkedTaskId',
  GlobalAccess.can('taskLinks', 'delete'),
  TaskTasksController.delete
);
router.get(
  '/task/:id/spent/',
...
router.post(
  '/timesheet/',
  GlobalAccess.can('timesheet', 'create'),
  TimesheetController.create
);
router.get(
  '/timesheet/tracksAll/',
  GlobalAccess.can('timesheet', 'trackAll'),
  TimesheetController.getTracksAll
);
router.get(
  '/timesheet',
  GlobalAccess.can('timesheet', 'list'),
  TimesheetController.list
);
router.put(
  '/timesheet',
  GlobalAccess.can('timesheet', 'update'),
  TimesheetController.update
);
router.delete(
  '/timesheet/:timesheetId',
  GlobalAccess.can('timesheet', 'delete'),
  TimesheetController.delete
);
router.put(
  '/draftsheet/',
  GlobalAccess.can('timesheet', 'update'),
  TimesheetController.updateDraft
);

// Comments
router.post(
  '/task/:taskId/comment',
  GlobalAccess.can('comment', 'create'),
  CommentController.create
);
router.put(
  '/task/:taskId/comment/:commentId',
  GlobalAccess.can('comment', 'update'),
  CommentController.update
);
router.delete(
  '/task/:taskId/comment/:commentId',
  GlobalAccess.can('comment', 'delete'),
  CommentController.delete
);
router.get(
  '/task/:taskId/comment',
  GlobalAccess.can('comment', 'list'),
  CommentController.list
);

// Dictionaries
router.get(
  '/dictionary/:entity(project|task|sprint|timesheet)/status',
...
router.get(
  '/:entity(project|task|sprint|timesheet)/status/dictionary/',
  DictionaryController.status
...
// History
router.get(
  '/:entity(project|task)/:entityId/history',
  GlobalAccess.can('history', 'list'),
